...
| 011a | 4 | [TODO](./011_PHASE4_SUPABASE_DEPLOY.md) | Supabase compose deploy + vault secrets (Dokploy) | `feat/supabase-deploy` | 009 |
| 011b | 4 | [TODO](./011B_PHASE4_SVELTEKIT_DEPLOY.md) | SvelteKit Docker deploy + env config (Dokploy) | `feat/sveltekit-deploy` | 009, 011a |
| 011c | 4 | [TODO](./011C_PHASE4_DNS_ROUTING.md) | DNS + Traefik routing + HTTPS | `feat/dns-routing` | 011a, 011b |
