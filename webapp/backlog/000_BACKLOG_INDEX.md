...
| 011c | 4 | [DONE](./011C_PHASE4_DNS_ROUTING.md) | Cloudflare DNS + Origin Cert (Option C, Kong closed) | `main` | 011a, 011b |
...
| 028 | 9 | [DEFERRED](./028_PHASE9_WALLET_REPUTATION.md) | Wallet reputation - deferred, needs real data | `feat/wallet-reputation` | 017 |
| 029 | 9 | [DEFERRED](./029_PHASE9_FEEDBACK_QUALITY.md) | Feedback quality signals - depends on 028, deferred | `feat/feedback-quality` | 028 |
| 030 | 10 | [DONE](./030_PHASE10_AGENT_UPDATE.md) | Agent profile edit & management UI | `feat/agent-update` | - |
| 031 | 9 | [DEFERRED](./031_PHASE9_ENDPOINT_HEALTH.md) | Endpoint health check - deferred, 0 endpoints, SSRF risk | `feat/endpoint-health` | 017 |
| 032 | 10 | [DONE](./032_PHASE10_MY_AGENTS_UX.md) | My Agents UX: owner filter, badges, WalletButton, CTAs | `feat/my-agents-ux` | 030 |
| 033 | 9 | [DEFERRED](./033_PHASE9_FILTERED_SCORING.md) | Filtered scoring - depends on 028, deferred | `feat/filtered-scoring` | 028 |
...
| 036 | 11 | [DONE](./036_PHASE11_SDK_DOGFOOD.md) | Dog-food: web app migration to SDK | `feat/sdk-dogfood` | 034, 035 |
| 037 | 11 | [DONE](./037_PHASE11_SDK_DOCS.md) | Developer portal: SDK docs + register example | `feat/sdk-docs` | 034 |
| 038 | 11 | [IN_PROGRESS](./038_PHASE11_SDK_PUBLISH.md) | npm publish: @trionlabs/8004-sdk | `feat/sdk-publish` | 034, 035, 036 |
