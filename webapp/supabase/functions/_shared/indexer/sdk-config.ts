// Vendored from webapp/packages/sdk/src/core/config.ts so the Deno edge runtime
// can import it without resolving the @trionlabs/8004-sdk workspace package.
// Keep in sync with the SDK after every contract redeploy.
