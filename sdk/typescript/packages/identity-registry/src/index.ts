...
export const networks = {
  testnet: {
    ...
    contractId: "CDO5LAZADIBBU2ERJLP5QFU2DEBFETREED3TJ2Y6UYMHIII7TCZHPM5T",
  }
} as const
...
export const IdentityError = {
  ...
  4: {message:"InvalidSignature"},
  5: {message:"WalletNotSet"},
  6: {message:"UriNotSet"}
}
...
export interface Client {
   ...
   */
  set_agent_wallet: ({caller, agent_id, new_wallet, deadline, signature, public_key}: {caller: string, agent_id: u32, new_wallet: string, deadline: u64, signature: Buffer, public_key: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAMAAAAAAAAABW93bmVyAAAAAAAAEwAAAAAAAAAEbmFtZQAAABAAAAAAAAAABnN5bWJvbAAAAAAAEAAAAAA=",
        ...
        "",
        ...
        "",
