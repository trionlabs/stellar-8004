...
- **SKILL.md for 8004 on Stellar** - `/8004stellar` and `/x402s` slash commands that let developers build on 8004 and x402 directly with AI assistance.
...
Then use `/8004stellar` and `/x402s` slash commands in Claude Code. See the [Developer Portal](https://stellar8004.com/developers) for full docs.
